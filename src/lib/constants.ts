...
export const TAG_MAX_OUTPUT_TOKENS = 180;
...
export const MAX_SESSION_ID_LEN = 120;
export const MAX_RUN_OUTPUT_LEN = 20_000;
export const MAX_RUN_STATUS_LEN = 40;
export const MAX_TRACE_SUMMARY_LEN = 8_000;
export const MAX_CHAT_TURN_LEN = 6_000;
